...
| Auth | **Continue as a Guest** | Guest checkout by default | Prefills **email** from config into Cognito **Log In**; waits for **Password AutoFill** (or manual password), then taps **Submit** — never ABM SSO / Create Account |
