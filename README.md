...
5. **Expired ~7-day cert (SideStore):** **no PC** — LocalDevVPN + Wi‑Fi → SideStore → tap **7 DAYS** / Refresh (works after expiry). PC only if pairing dies (iloader). AltStore still needs AltServer + USB **Refresh All**.
