...
3. Download artifact **`ParkMobileParking-ipa`** → `ParkMobileParking.ipa`.
...
2. On the **iPhone**: **AltStore → My Apps → +** → pick `ParkMobileParking.ipa` (not AltServer “Sideload” on PC if you want refresh).
